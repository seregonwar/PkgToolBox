...
Te4 = [
    0xc66363a5, 0x7c7c7c84, 0x77777799, 0x7b7b7b8d,
    0xf2f2f20d, 0x6b6b6bbd, 0x6f6f6fb1, 0xc5c5c554,
    0x30303050, 0x01010101, 0x676767a9, 0x2b2b2b7d,
    0xfefefe19, 0xd7d7d762, 0xababab4d, 0x7676769a,
    0xcacaca45, 0x8282829d, 0xc9c9c940, 0x7d7d7d87,
    0xfafafa15, 0x595959eb, 0x474747c9, 0xf0f0f00b,
    0xadadadec, 0xd4d4d467, 0xa2a2a2fd, 0xafafafea,
    0x9c9c9cbf, 0xa4a4a4f7, 0x72727296, 0xc0c0c05b,
    0xb7b7b7c2, 0xfdfdf1ce, 0x939393ae, 0x2626266a,
    0x3636365a, 0x3f3f3f41, 0xf7f7f702, 0xcccccc4f,
    0x3434345c, 0xa5a5a5f4, 0xe5e5e534, 0xf1f1f108,
    0x71717193, 0xd8d8d873, 0x31313153, 0x1515153f,
    0x0404040c, 0xc7c7c752, 0x23232365, 0xc3c3c35e,
    0x18181828, 0x969696a1, 0x0505050f, 0x9a9a9ab5,
    0x07070709, 0x12121236, 0x8080809b, 0xe2e2e23d,
    0xebebeb26, 0x27272769, 0xb2b2b2cd, 0x7575759f,
    0x0909091b, 0x8383839e, 0x2c2c2c74, 0x1a1a1a2e,
    0x1b1b1b2d, 0x6e6e6eb2, 0x5a5a5aeeb, 0xa0a0a0fb,
    0x525252f6, 0x3b3b3b4d, 0xd6d6d661, 0xb3b3b3ce,
    0x2929297b, 0xe3e3e33e, 0x2f2f2f71, 0x84848497,
    0x535353f5, 0xd1d1d168, 0x00000000, 0xededed2c,
    0x20202060, 0xfcfcfc1f, 0xb1b1b1c8, 0x5b5b5bed,
    0x6a6a6abe, 0xcbcbcb46, 0xbebebed9, 0x3939394b,
    0x4a4a4ade, 0x4c4c4cd4, 0x585858e8, 0xcfcfcf4a,
    0xd0d0d06b, 0xefefef2a, 0xaaaaaaaa, 0xfbfbfb16,
    0x434343c5, 0x4d4d4dd7, 0x33333355, 0x85858594,
    0x454545cf, 0xf9f9f910, 0x02020206, 0x7f7f7f81,
    0x505050f0, 0x3c3c3c44, 0x9f9f9fba, 0xa8a8a8e3,
    0x515151f3, 0xa3a3a3fe, 0x404040c0, 0x8f8f8f8a,
    0x929292ad, 0x9d9d9dbc, 0x38383848, 0xf5f5f504,
    0xbcbcbcdf, 0xb6b6b6c1, 0xdada67a7, 0x21212163,
    0x10101030, 0xffff1fef, 0xf3f3f30e, 0xd2d2d26d,
    0xcdcdcd4c, 0x0c0c0c14, 0x13131335, 0xecec2f3d,
    0x5f5fe1be, 0x9797a235, 0x4444cc88, 0x1717392e,
    0xc4c45793, 0xa7a7f255, 0x7e7e7e82, 0x3d3d3d47,
    0x6464acdc, 0x5d5de7ba, 0x19192b32, 0x737395e6,
    0x6060a0c0, 0x81819819, 0x4f4fd19e, 0xdcdc7fa3,
    0x22226644, 0x2a2a7e54, 0x9090ab3b, 0x8888830b,
    0x4646ca8c, 0xeeee29c7, 0xb8b8d36b, 0x14143c28,
    0xdede79a7, 0x5e5ee2bc, 0x0b0b1d16, 0xdbdb76ad,
...
Td2 = [
    ...
    0x6e65e695, 0xe67eaaffe, 0xcf0821bc, 0xe8e6ef15,
...
def rijndaelKeySetupEnc(rk, cipherKey, keyBits):
    ...
    if keyBits == 128:
        for i in range(10):
            ...
            if index1 >= len(Te4) or index2 >= len(Te4) or index3 >= len(Te4) or index4 >= len(Te4):
